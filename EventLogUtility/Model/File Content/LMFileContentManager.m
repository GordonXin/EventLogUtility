...
#import "LMFileContentManager.h"
#import "LMFileContent.h"

@interface LMFileContentManager()
{
...
@implementation LMFileContentManager
...
#pragma mark -
static LMFileContentManager *sharedManager = nil;
+(instancetype)sharedManager
{
    if (sharedManager == nil)
    {
        sharedManager = [[LMFileContentManager alloc] init];
    }
...
#pragma mark -
+(LMFileContent *)createOriginFileContentWithURL:(NSURL *)absoluteURL option:(NSDictionary *)options error:(NSError *__autoreleasing*)outError
{
    LMFileContent *fileContent = [[LMFileContentManager sharedManager] fileContentWithURL:absoluteURL];
    if (fileContent)
    {
        // already exist
        return fileContent;
